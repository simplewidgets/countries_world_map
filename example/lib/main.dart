          ...
          child: Center(
            child: NetherlandsMap(
                ...
                netherlandsColors: NetherlandsColors(
                  utrecht: colors[_random.nextInt(5)],
                  gelderland: colors[_random.nextInt(5)],
                  noordbrabant: colors[_random.nextInt(5)],
                  noordholland: colors[_random.nextInt(5)],
                  zuidholland: colors[_random.nextInt(5)],
                  zeeland: colors[_random.nextInt(5)],
                  limburg: colors[_random.nextInt(5)],
                  flevoland: colors[_random.nextInt(5)],
                  drenthe: colors[_random.nextInt(5)],
                  groningen: colors[_random.nextInt(5)],
                  overijssel: colors[_random.nextInt(5)],
                  friesland: colors[_random.nextInt(5)],
                )),
            // child: Row(
            //   children: [
            //     SizedBox(
            ...
            //         countryColors: SimpleWorldMapCountryColors(
